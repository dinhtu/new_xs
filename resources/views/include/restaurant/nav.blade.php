<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    ...
    <ul class="c-sidebar-nav">
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="{{ route('restaurant.readHistory.index') }}">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="{{ route('restaurant.pastTraceAbility.index') }}">
                <svg class="c-sidebar-nav-icon">
                    <use xlink:href="{{ url('assets/icons/coreui/free.svg#cui-settings') }}"></use>
                </svg>
                現在進行中のトレーサビリティ情報
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="{{ route('restaurant.info.index') }}">
                <svg class="c-sidebar-nav-icon">
                    <use xlink:href="{{ url('assets/icons/coreui/free.svg#cui-settings') }}"></use>
                </svg>
                過去のトレーサビリティ情報
        ...
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link" href="{{ route('restaurant.profile.create') }}">
